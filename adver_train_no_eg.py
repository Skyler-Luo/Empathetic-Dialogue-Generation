...
def pre_train_d_new(model_g, model_d, iters=1000, resume=False):
    if resume:
        ...
        writer = SummaryWriter(log_dir="results/tb_results/EmpDG_sem_D/")
...
def adver_joint_train_gd(model_g, model_d, itr_num=5000):
    ...
    model_d.cuda()
    current_step = 0
    disc_log = open("results/tb_results/sem_disc_log.txt", 'w', encoding="utf-8")
